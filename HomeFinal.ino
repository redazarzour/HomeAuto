...
WiFiMulti wifiMulti;
const char* ssid_4G = "xxxxxxxxxxxxB";
const char* password_4G = "Gssss";
...
// Digital Inputs
const int inputPins[5] = { 12, 11, 10, 9, 46 };  //19 21 22 23 18
int inputStates[5] = { 0 };
int previousInputStates[5] = { 0 };

// Digital Outputs (6 channels 12V control)
const int outputPins[6] = { 3, 20, 19, 8, 18, 17 };  //13 14 27 26 25 33
...
const int redPins[6] = { 3, 20, 19, 8, 18, 17 };     //13, 14, 27, 26, 25, 33
const int greenPins[6] = { 16, 15, 7, 6, 5, 4 };     //12, 15, 32, 21, 22, 23
const int bluePins[6] = { 13, 14, 21, 47, 48, 45 };  //19, 18, 5, 17, 16, 4
...
void setup() {
  ...
  vTaskPrioritySet(loopTaskHandle, 3);
  // ... rest of setup
  Serial.begin(115200);
...
}  // This is the correct closing brace for setup()
